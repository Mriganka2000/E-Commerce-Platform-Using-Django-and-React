                    ...
                    : (
                        <div>
                            ...
                            <Row className='mt-5'>
                                <Col md={6}>
                                    <h4>Reviews</h4>
                                    {product.reviews.length === 0 && <Message variant='info'>No reviews for this product</Message>}
                                    ...
                                    <ListGroup variant='flush'>
                                        {product.reviews.map((review) => (
                                            <ListGroup.Item key={review._id}>
                                                ...
                                                <Row className='float-right'>
                                                    <Rating value={review.rating} color='#fbc531'/>
                                                </Row>
                                        ...
                                        <ListGroup.Item>
                                            ...
                                            {userInfo ? (
                                                ...
                                                <Message variant='info'>You are not logged in <Link to='/login'>Please Login here</Link></Message>
                                            )}
                                        </ListGroup.Item>
                                    </ListGroup>
                                </Col>
